...
- [Dwarkesh Patel "lecture" with Reiner Pope](https://www.youtube.com/watch?v=xmkSf5IS-zw&t) -> The new format with the blackboard interview is amazing! In depth talk on how LLMs are served: token cost vs batch size, MoE vs GPU racks...
